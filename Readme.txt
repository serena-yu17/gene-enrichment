...
int data[]:input the total list of pairs of gene id in the form of integers. e.g. a database [TP53->MDM4, AKT1-> MDM2] will be numbered in the outside code into (data[342, 4324, 5646, 13]), which represents 2 relation pairs of TP53->MDM4 and AKT1->MDM2.
 
int nData: input total length of (data[]). If incorrectly set, it will cause a memory read outbond.
